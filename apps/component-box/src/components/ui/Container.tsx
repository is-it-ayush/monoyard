  ...
  return (
    <div className="m-5 flex flex-col">
      ...
      <div className="relative mt-5 rounded-sm">
        <div className="bg-400 absolute inset-0.5 bg-[conic-gradient(at_bottom_left,_var(--tw-gradient-stops))] from-slate-900 via-purple-900 to-slate-900 opacity-75 blur-lg"></div>
        <div
          className={cn(
