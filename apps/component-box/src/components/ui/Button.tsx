...
const ButtonStyles = cva('flex px-3 py-2 border-2 items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed my-2 transition-colors duration-200', {
  variants: {
    style: {
