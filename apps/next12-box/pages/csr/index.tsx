...
export default function CSRPage({ time }: { time: Date }) {
  return (
    <div className="dark:text-blackfirst-letter: font-poppins flex h-screen items-center justify-center dark:bg-black">
      ...
      <footer className="fixed bottom-5 w-full text-center">
        <div className="flex flex-col justify-evenly dark:text-white lg:flex-row">
          ...
          <h1>CSR: Server Side Rendering</h1>
        </div>
      </footer>
    </div>
  );
